...
describe("Likes", () => {
  it("should add a like to the like counter of the repository", async () => {
    ...
    expect(getByTestId(`repository-likes-${repositoryId}`)).toHaveTextContent("1 like(s)");
    ...
    expect(getByTestId(`repository-likes-${repositoryId}`)).toHaveTextContent("2 like(s)");
  });
});
